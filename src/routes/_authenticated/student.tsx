...
import { LayoutDashboard, CreditCard, FileCheck2, TrendingUp } from "lucide-react";
  ...
  component: () => {
    ...
    return (
      <PortalShell title={t("student_portal")} items={[
        ...
        { to: "/student/development", label: "My Development",       icon: <TrendingUp className="h-4 w-4" /> },
