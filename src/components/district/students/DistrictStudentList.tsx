// src/components/district/students/DistrictStudentList.tsx
...
interface DistrictStudentListProps {
  students: Student[];
  onExport?: () => void;
  district?: string;
}

export function DistrictStudentList({ students, onExport, district }: DistrictStudentListProps) {
